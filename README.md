...
* **⚡ ASP.NET Core Web API:** High-performance RESTful API that handles real-time RFID card validation and access logging.
* **🖥️ .NET MAUI Desktop App:** Cross-platform desktop interface simulating physical card scans with dynamic feedback.
